...
#define UA_DATATYPEKINDS 32
typedef enum {
    UA_DATATYPEKIND_NULL = 0, /* type not assigned */
    UA_DATATYPEKIND_BOOLEAN = 1,
    UA_DATATYPEKIND_SBYTE = 2,
    UA_DATATYPEKIND_BYTE = 3,
    UA_DATATYPEKIND_INT16 = 4,
    UA_DATATYPEKIND_UINT16 = 5,
    UA_DATATYPEKIND_INT32 = 6,
    UA_DATATYPEKIND_UINT32 = 7,
    UA_DATATYPEKIND_INT64 = 8,
    UA_DATATYPEKIND_UINT64 = 9,
    UA_DATATYPEKIND_FLOAT = 10,
    UA_DATATYPEKIND_DOUBLE = 11,
    UA_DATATYPEKIND_STRING = 12,
    UA_DATATYPEKIND_DATETIME = 13,
    UA_DATATYPEKIND_GUID = 14,
    UA_DATATYPEKIND_BYTESTRING = 15,
    UA_DATATYPEKIND_XMLELEMENT = 16,
    UA_DATATYPEKIND_NODEID = 17,
    UA_DATATYPEKIND_EXPANDEDNODEID = 18,
    UA_DATATYPEKIND_STATUSCODE = 19,
    UA_DATATYPEKIND_QUALIFIEDNAME = 20,
    UA_DATATYPEKIND_LOCALIZEDTEXT = 21,
    UA_DATATYPEKIND_EXTENSIONOBJECT = 22,
    UA_DATATYPEKIND_DATAVALUE = 23,
    UA_DATATYPEKIND_VARIANT = 24,
    UA_DATATYPEKIND_DIAGNOSTICINFO = 25,
    UA_DATATYPEKIND_DECIMAL = 26,
    UA_DATATYPEKIND_ENUM = 27,
    UA_DATATYPEKIND_STRUCTURE = 28,
    UA_DATATYPEKIND_OPTSTRUCT = 29, /* struct with optional fields */
    UA_DATATYPEKIND_UNION = 30,
    UA_DATATYPEKIND_BITFIELDCLUSTER = 31 /* bitfields + padding */
} UA_DataTypeKind;
