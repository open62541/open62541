...
struct UA_CertificateGroup {
     ...
     * Steps: 1, 2, 3, 4, 9 */
    UA_StatusCode (*verifyCertificateIntegrity)(UA_CertificateGroup *certGroup, const UA_ByteString *certificate);
    /* This function verifies the validity of a certificate by checking its expiration date, validity period,
     * and whether it appears on a certificate revocation list.
     * See https://reference.opcfoundation.org/Core/Part4/v104/docs/6.1.3 Table 106
     * Steps: 6, 10, 11 */
    UA_StatusCode (*verifyCertificateValidity)(UA_CertificateGroup *certGroup, const UA_ByteString *certificate);
    /* This function verifies the trustworthiness of a certificate.
     * See https://reference.opcfoundation.org/Core/Part4/v104/docs/6.1.3 Table 106
     * Step: 5 */
    UA_StatusCode (*verifyCertificateTrust)(UA_CertificateGroup *certGroup, const UA_ByteString *certificate);
