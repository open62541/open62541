...
/* While server initialization, value callbacks are called twice. This counter
 * is used to ensure that the deletion of the variable is triggered by the
...
afterWriteTime(UA_Server *tmpServer,
               ...
               const UA_NodeId *nodeId, void *nodeContext,
               const UA_NumericRange *range, const UA_DataValue *data) {
    UA_LOG_INFO(UA_Log_Stdout, UA_LOGCATEGORY_APPLICATION, "The variable was updated");
}
