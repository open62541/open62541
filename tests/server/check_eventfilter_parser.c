...
START_TEST(Case_0) {
    ...
    UA_StatusCode res = UA_EventFilter_parse(&filter, case0, NULL);
...
START_TEST(Case_2) {
    ...
    UA_StatusCode res = UA_EventFilter_parse(&filter, case2, NULL);
    ck_assert_int_eq(res, UA_STATUSCODE_GOOD);
    UA_EventFilter_clear(&filter);
} END_TEST
...
START_TEST(Case_3) {
    ...
    UA_StatusCode res = UA_EventFilter_parse(&filter, case1, NULL);
    res |= UA_EventFilter_parse(&filter2, case2, NULL);
    ck_assert_int_eq(res, UA_STATUSCODE_GOOD);
...
START_TEST(Case_7) {
    ...
    UA_StatusCode res = UA_EventFilter_parse(&filter, case7, NULL);
...
START_TEST(Case_8) {
    ...
    UA_StatusCode res = UA_EventFilter_parse(&filter, case8, NULL);
    ck_assert_int_ne(res, UA_STATUSCODE_GOOD);
    UA_EventFilter_clear(&filter);
} END_TEST
...
START_TEST(Case_9) {
    ...
    UA_StatusCode res = UA_EventFilter_parse(&filter, case9, NULL);
    ck_assert_int_ne(res, UA_STATUSCODE_GOOD);
    UA_EventFilter_clear(&filter);
} END_TEST
...
START_TEST(Case_10) {
    ...
    UA_StatusCode res = UA_EventFilter_parse(&filter, case10, NULL);
    ck_assert_int_eq(res, UA_STATUSCODE_GOOD);
    UA_EventFilter_clear(&filter);
} END_TEST
...
START_TEST(Case_11) {
    ...
    UA_StatusCode res = UA_EventFilter_parse(&filter, case11, NULL);
    ck_assert_int_ne(res, UA_STATUSCODE_GOOD);
    UA_EventFilter_clear(&filter);
} END_TEST
