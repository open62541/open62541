...
static void setup(void) {
    ...
    /* Debug this test with longer timeouts */
    /*
    config->maxSessionTimeout = 1000000;
    config->asyncOperationTimeout = 1000000;
    */
    ...
    ck_assert(retval == UA_STATUSCODE_GOOD);
#ifdef UA_ENABLE_ENCRYPTION
    retval = UA_ServerConfig_addEndpoint(config, UA_STRING_ALLOC("http://opcfoundation.org/UA/SecurityPolicy#Basic256Sha256"),
