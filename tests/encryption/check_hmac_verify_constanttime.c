...
START_TEST(mbedtlsHmacSha256VerifyRejectsTamperedAndShortSignatures) {
    check_verify_helper(UA_mbedTLS_HMAC_SHA256_Sign, UA_mbedTLS_HMAC_SHA256_Verify, 32);
}
END_TEST

START_TEST(mbedtlsHmacSha384VerifyRejectsTamperedAndShortSignatures) {
    check_verify_helper(UA_mbedTLS_HMAC_SHA384_Sign, UA_mbedTLS_HMAC_SHA384_Verify, 48);
}
END_TEST
