...
asym_verify_sp_basic256sha256(const UA_SecurityPolicy *securityPolicy,
    ...
    /* Compute the SHA256 aka SHA2 or SHA-2 hash */
...
static size_t
asym_getRemoteEncryptionKeyLength_basic256sha256(const UA_SecurityPolicy *securityPolicy,
                                  const Basic256Sha256_ChannelContext *cc) {
...
asym_makeThumbprint_sp_basic256sha256(const UA_SecurityPolicy *securityPolicy,
    ...
    mbedtls_sha256(certificate->data, certificate->length, thumbprint->data, 0);
    return UA_STATUSCODE_GOOD;
}
...
static size_t
channelContext_getRemoteAsymPlainTextBlockSize_sp_basic256sha256(const Basic256Sha256_ChannelContext *cc) {
...
static size_t
channelContext_getRemoteAsymEncryptionBufferLengthOverhead_sp_basic256sha256(const Basic256Sha256_ChannelContext *cc,
                                                                            size_t maxEncryptionLength) {
    const size_t maxNumberOfBlocks = maxEncryptionLength /
        channelContext_getRemoteAsymPlainTextBlockSize_sp_basic256sha256(cc);
    return maxNumberOfBlocks * UA_SECURITYPOLICY_BASIC256SHA256_RSAPADDING_LEN;
}
...
UA_SecurityPolicy_Basic256Sha256(UA_SecurityPolicy *policy, const UA_ByteString localCertificate,
    ...
    channelModule->getRemoteAsymPlainTextBlockSize = (size_t (*)(const void *))
        channelContext_getRemoteAsymPlainTextBlockSize_sp_basic256sha256;
    channelModule->getRemoteAsymEncryptionBufferLengthOverhead = (size_t (*)(const void *, size_t))
        channelContext_getRemoteAsymEncryptionBufferLengthOverhead_sp_basic256sha256;
