...
#define UA_SECURITYPOLICY_BASIC256SHA256_MINASYMKEYLENGTH 128 /* IN BYTE (1024/8) */
#define UA_SECURITYPOLICY_BASIC256SHA256_MAXASYMKEYLENGTH 512 /* IN BYTE (4096/8) */
