...
static UA_StatusCode
asym_signAuth_sp_basic256sha256(ChannelContext_mbedtls *cc,
                                const UA_ByteString *message,
                                UA_ByteString *signature,
...
UA_SecurityPolicy_Basic256Sha256(UA_SecurityPolicy *policy, const UA_Logger *logger) {
    ...
    asym_signatureAlgorithm->signAuth =
        (UA_StatusCode (*)(void *, const UA_ByteString *, UA_ByteString *, UA_ByteString*))asym_signAuth_sp_basic256sha256;
