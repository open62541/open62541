...
static UA_StatusCode
UA_OpenSSL_AES_CBC_Decrypt (const UA_ByteString * iv,
                            const UA_ByteString * key,
...
static UA_StatusCode
UA_OpenSSL_AES_CBC_Encrypt (const UA_ByteString * iv,
                            const UA_ByteString * key, 
                            const EVP_CIPHER *    cipherAlg,
                            UA_ByteString *       data  /* [in/out]*/
                            ) {
...
UA_OpenSSL_AES_256_CBC_Decrypt (const UA_ByteString * iv,
    ...
    return UA_OpenSSL_AES_CBC_Decrypt (iv, key, EVP_aes_256_cbc (), data);                                
}
...
UA_OpenSSL_AES_256_CBC_Encrypt (const UA_ByteString * iv,
    ...
    return UA_OpenSSL_AES_CBC_Encrypt (iv, key, EVP_aes_256_cbc (), data);
}
