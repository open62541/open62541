...
GenericApplicationDescriptionField_parseJson(ParsingCtx *ctx, void *configField, size_t *configFieldSize, ApplicationType applicationType)
{
        ...
        case CJ5_TOKEN_STRING: {
            ...
            if(strcmp(field_str, "applicationUri") == 0)
                ...
                LocalizedTextField_parseJson(ctx, &field->applicationName, NULL);
                    ...
                    applicationType != APPLICATIONTYPE_CLIENT) {
    ...
    if(applicationType == APPLICATIONTYPE_CLIENT) {
        ...
        switch (tok.type) {
            case CJ5_TOKEN_STRING: {
                ...
                if(strcmp(field, "buildInfo") == 0)
                    ...
                    retval = GenericApplicationDescriptionField_parseJson(&ctx, &config->applicationDescription, NULL, APPLICATIONTYPE_SERVER);
    ...
    for(size_t j = tok.size/2; j > 0; j--) {
        ...
        case CJ5_TOKEN_STRING: {
            ...
            if(strcmp(field_str, "policyId") == 0)
                ...
                field->tokenType = (UA_UserTokenType)enum_value;
            }
    ...
    for(size_t j = tok.size/2; j > 0; j--) {
        ...
        case CJ5_TOKEN_STRING: {
            ...
            if(strcmp(field_str, "endpointUrl") == 0)
                ...
                GenericApplicationDescriptionField_parseJson(ctx, &field->server, NULL, APPLICATIONTYPE_ANY);
        ...
        switch (tok.type) {
            case CJ5_TOKEN_STRING: {
                ...
                if(strcmp(field, "timeout") == 0)
                    ...
                    retval = GenericApplicationDescriptionField_parseJson(&ctx, &config->clientDescription, NULL, APPLICATIONTYPE_CLIENT);
