...
UA_EXPORT void
UA_CertificateVerification_AcceptAll(const UA_Logger *logger, UA_CertificateVerification *cv);
...
UA_CertificateVerification_Trustlist(const UA_Logger *logger, UA_CertificateVerification *cv,
...
UA_EXPORT UA_StatusCode
UA_CertificateVerification_CertFolders(const UA_Logger *logger, UA_CertificateVerification *cv,
