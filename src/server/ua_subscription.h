...
typedef struct UA_Notification {
    TAILQ_ENTRY(UA_Notification) monEntry; /* Notification list for the MonitoredItem */
    TAILQ_ENTRY(UA_Notification) subEntry; /* Notification list for the Subscription */
