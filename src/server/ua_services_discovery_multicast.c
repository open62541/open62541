...
void Service_FindServersOnNetwork(UA_Server *server, UA_Session *session,
    ...
    /* Count the records matching the filter. Do not allocate a cache-sized
     * temporary array on the stack. The service mutex keeps the list stable
     * between this pass and the copy pass below. */
