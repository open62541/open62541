...
parse_qn(UA_QualifiedName *qn, const u8 *pos, const u8 *end,
    ...
    /* A namespace URI must start with a non-digit character (e.g. "http://...").
     * This prevents re2c's longest-match from treating "123:te;st" as
     * URI="123:te" + name="st" instead of nsIndex=123, name="te;st". */
