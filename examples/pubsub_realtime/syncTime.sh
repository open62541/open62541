...
# Dependency package
# Install linuxptp 2.0

#192.168.10.XX - (10/11) in line number 33 indicates the last two digits to assign IP for the node

usage() {
        echo "Run the script as mentioned below:"
        echo "./syncTime.sh <i210_interface name > <Last two digits of IP address> <master/slave>"
        echo "example: ./syncTime.sh eth0 10 master"
