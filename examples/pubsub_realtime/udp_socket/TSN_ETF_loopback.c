 ...
 * use the command  ./executable "publsiher_mac(MAC of node1)" "subscriber_mac(MAC of node 2)" interface_name
 * To run only subscriber, use the command ./executable "subscriber_mac(MAC of node 2)" interface_name
