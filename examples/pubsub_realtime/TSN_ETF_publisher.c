...
int main(int argc, char **argv) {
    ...
    if (argc > 1) {
        ...
        networkAddressUrlEthernet.url = UA_STRING("opc.eth://00-07-32-6b-a6-d3"); /* MAC address of subscribing node*/
#endif
#if defined(SUBSCRIBER)
        networkAddressUrlSub.url = UA_STRING("opc.eth://00-07-32-6b-a6-ab"); /* Self MAC address */
