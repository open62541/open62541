...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  ...
  l10:;	  yy->__pos= yypos9; yy->__thunkpos= yythunkpos9;  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
if (!(YY_BEGIN)) goto l11;
#undef yytext
#undef yyleng
  }  if (!yy_ID(yy)) goto l11;  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
if (!(YY_END)) goto l11;
#undef yytext
#undef yyleng
  ...
  l11:;	  yy->__pos= yypos9; yy->__thunkpos= yythunkpos9;  if (!yy_OPEN(yy)) goto l8;  if (!yy_Expr(yy)) goto l8;  if (!yy_CLOSE(yy)) goto l8;
  }
  l9:;	
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "MINUS"));  if (!yymatchChar(yy, '-')) goto l13;  if (!yy_SPACE(yy)) goto l13;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "PLUS"));  if (!yymatchChar(yy, '+')) goto l14;  if (!yy_SPACE(yy)) goto l14;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "Product"));  if (!yy_Value(yy)) goto l15;
  l16:;	
  {  int yypos17= yy->__pos, yythunkpos17= yy->__thunkpos;
  {  int yypos18= yy->__pos, yythunkpos18= yy->__thunkpos;  if (!yy_TIMES(yy)) goto l19;  if (!yy_Value(yy)) goto l19;  yyDo(yy, yy_1_Product, yy->__begin, yy->__end);  goto l18;
  l19:;	  yy->__pos= yypos18; yy->__thunkpos= yythunkpos18;  if (!yy_DIVIDE(yy)) goto l17;  if (!yy_Value(yy)) goto l17;  yyDo(yy, yy_2_Product, yy->__begin, yy->__end);
  }
  l18:;	  goto l16;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "Sum"));  if (!yy_Product(yy)) goto l20;
  l21:;	
  {  int yypos22= yy->__pos, yythunkpos22= yy->__thunkpos;
  {  int yypos23= yy->__pos, yythunkpos23= yy->__thunkpos;  if (!yy_PLUS(yy)) goto l24;  if (!yy_Product(yy)) goto l24;  yyDo(yy, yy_1_Sum, yy->__begin, yy->__end);  goto l23;
  l24:;	  yy->__pos= yypos23; yy->__thunkpos= yythunkpos23;  if (!yy_MINUS(yy)) goto l22;  if (!yy_Product(yy)) goto l22;  yyDo(yy, yy_2_Sum, yy->__begin, yy->__end);
  }
  l23:;	  goto l21;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "ASSIGN"));  if (!yymatchChar(yy, '=')) goto l25;  if (!yy_SPACE(yy)) goto l25;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "Expr"));
  {  int yypos33= yy->__pos, yythunkpos33= yy->__thunkpos;  if (!yy_ID(yy)) goto l34;  yyDo(yy, yy_1_Expr, yy->__begin, yy->__end);  if (!yy_ASSIGN(yy)) goto l34;  if (!yy_Sum(yy)) goto l34;  yyDo(yy, yy_2_Expr, yy->__begin, yy->__end);  goto l33;
  l34:;	  yy->__pos= yypos33; yy->__thunkpos= yythunkpos33;  if (!yy_Sum(yy)) goto l32;
  }
  l33:;	
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "Stmt"));
  {  int yypos39= yy->__pos, yythunkpos39= yy->__thunkpos;  if (!yy_SPACE(yy)) goto l40;  if (!yy_Expr(yy)) goto l40;  if (!yy_EOL(yy)) goto l40;  yyDo(yy, yy_1_Stmt, yy->__begin, yy->__end);  goto l39;
