...
addDataSetReader(UA_Server *server) {
    ...
    UA_UInt64 publisherIdentifier = 2234;

    /* Use UA_UInt64 as the datatype for PublisherId as JSON decoding supports
     * that datatype only */
    readerConfig.publisherId.type = &UA_TYPES[UA_TYPES_UINT64];
