...
try {
    ...
    if ($env:CC_SHORTNAME -eq "mingw") {
        ...
        $vcpkg_toolchain = '-G Ninja -DCMAKE_C_COMPILER=clang-cl.exe -DCMAKE_CXX_COMPILER=clang-cl.exe -DCMAKE_TOOLCHAIN_FILE="C:/Tools/vcpkg/scripts/buildsystems/vcpkg.cmake"'
    } else {
