...
if [ $ANALYZE = "true" ]; then
    ...
    if [ "$CC" = "gcc" ]; then
        ...
        make -j
        zip -r open62541-win32.zip ../../doc_latex/open62541.pdf ../LICENSE ../AUTHORS ../README.md ../bin/examples/server.exe ../bin/examples/client.exe libopen62541.dll.a open62541.h open62541.c
        ...
        make -j
        zip -r open62541-win64.zip ../../doc_latex/open62541.pdf ../LICENSE ../AUTHORS ../README.md ../bin/examples/server.exe ../bin/examples/client.exe libopen62541.dll.a open62541.h open62541.c
        ...
        make -j
        tar -pczf open62541-linux32.tar.gz ../../doc_latex/open62541.pdf ../LICENSE ../AUTHORS ../README.md ../bin/examples/server ../bin/examples/client libopen62541.a open62541.h open62541.c
        ...
        make -j
        tar -pczf open62541-raspberrypi.tar.gz ../../doc_latex/open62541.pdf ../LICENSE ../AUTHORS ../README.md ../bin/examples/server ../bin/examples/client libopen62541.a open62541.h open62541.c
    ...
    make -j
    tar -pczf open62541-linux64.tar.gz ../../doc_latex/open62541.pdf ../LICENSE ../AUTHORS ../README.md ../bin/examples/server ../bin/examples/client libopen62541.a open62541.h open62541.c
