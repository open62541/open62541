...
from .type_parser import (BuiltinType, CSVBSDTypeParser, EnumerationType,
                          OpaqueType, StructType)
...
def main(argv=None):
    ...
    generator = CGenerator(typeParser, inname, args.outfile, args.internal, args.gen_doc, namespaceMap, args.export_macro)
