...
example_args = {
        "client_encryption":"opc.tcp://localhost:4840 client.cert.der client.key.der server.cert.der",
        "access_control_client_encrypt":"opc.tcp://localhost:4840 client.cert.der client.key.der server.cert.der",
        "client_event_filter":"opc.tcp://localhost:4840",
        "client_connect":"-username user1 -password password -cert client.cert.der -key client.key.der opc.tcp://localhost:4840",
        ...
        "server_encryption":"server.cert.der server.key.der client.cert.der",
        "server_encryption_filestore":"server.cert.der server.key.der",
        "server_loglevel":"--loglevel=1",
        "ci_server":"4840 server.cert.der server.key.der client.cert.der",
        "server_json_config":"server_json_config.json5",
        "client_json_config":"client_json_config.json5",
        }

server_needed_examples = {
        "access_control_client":"ci_server 4840 server.cert.der server.key.der client.cert.der",
        "access_control_client_encrypt":"ci_server 4840 server.cert.der server.key.der client.cert.der",
        "client":"ci_server 4840 server.cert.der server.key.der client.cert.der",
        "client_async":"ci_server 4840 server.cert.der server.key.der client.cert.der",
        "client_connect":"ci_server 4840 server.cert.der server.key.der client.cert.der",
        ...
        "pubsub_publish_encrypted_sks":"server_pubsub_central_sks server.cert.der server.key.der --enableUnencrypted --enableAnonymous",
        "pubsub_subscribe_encrypted":"pubsub_publish_encrypted",
        "pubsub_subscribe_encrypted_sks":"server_pubsub_central_sks server.cert.der server.key.der --enableUnencrypted --enableAnonymous",
        ...
        "tutorial_server_reverseconnect":"ci_server 4841 client.cert.der client.key.der server.cert.der"
}
...
client_needed_examples = {
        ...
        "server_encryption":"client_encryption opc.tcp://localhost:4840 client.cert.der client.key.der server.cert.der",
