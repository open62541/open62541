...
int main(int argc, char** argv)
{
    ...
    UA_NodeId newNodeId = UA_NODEID_STRING_ALLOC(1, "the.answer");
    UA_NodeId parentNodeId = UA_NODEID_NUMERIC(0, UA_NS0ID_OBJECTSFOLDER);
    UA_NodeId parentReferenceNodeId = UA_NODEID_NUMERIC(0, UA_NS0ID_ORGANIZES);
    UA_NodeId variableType = UA_NODEID_NULL; /* take the default variable type */
    UA_QualifiedName browseName = UA_QUALIFIEDNAME_ALLOC(1, "the answer");
...
int main(int argc, char* argv[])
{
    ...
    status = UA_Client_readValueAttribute(client, UA_NODEID_STRING_ALLOC(1, "the.answer"), &value);
    if (status == UA_STATUSCODE_GOOD &&
